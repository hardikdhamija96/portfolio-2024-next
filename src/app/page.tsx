  ...
  return (
    <div className="bg-darkBg absolute h-full z-[-10] w-full px-2">
      <div className="h-full max-w-7xl mx-auto flex flex-col justify-center items-center">
        ...
        <p
          className={`${montSerrat.className} text-xl text-center text-headingColor pb-4`}>
          Software Developer Specialized in React
        </p>
        {/* <h1
        ...
        <div className="flex flex-col gap-3 py-4 w-full justify-center items-center text-green-500 text-2xl font-bold">
          <span className="text-green-500">Available for hiring!</span>
          <span> Can join Immediately</span>
        </div>
      </div>
    </div>
  );
